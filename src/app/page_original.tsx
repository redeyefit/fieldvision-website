  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 flex justify-between items-center bg-gradient-to-b from-fv-black/95 to-transparent backdrop-blur-md">
        <Link href="/" className="flex items-center gap-2 md:gap-3 font-display font-semibold text-base md:text-lg flex-shrink-0">
          <div className="bg-white rounded-full p-1 md:p-1.5">
            <Image src="/logo_backup.png" alt="FieldVision" width={24} height={24} className="w-5 h-5 md:w-6 md:h-6" />
          </div>
          <span className="hidden sm:inline">FieldVision AI</span>
        </Link>
        <div className="flex items-center gap-2 md:gap-3">
          <a
            ...
            className="font-display font-medium text-xs md:text-sm px-3 md:px-4 py-2 bg-fv-blue text-white rounded-md hover:bg-fv-blue/90 transition-all duration-300 flex items-center gap-1.5 md:gap-2 whitespace-nowrap"
          >
            ...
            <span className="hidden md:inline">Download on App Store</span>
            <span className="md:hidden">App Store</span>
          </a>
          <Link
            href="/schedule"
            className="font-display font-medium text-xs md:text-sm px-3 md:px-4 py-2 text-fv-blue border border-fv-blue rounded-md hover:bg-fv-blue/10 transition-all duration-300 flex items-center gap-1.5 md:gap-2 whitespace-nowrap"
          >
            ...
            <span className="hidden md:inline">Try Schedule Maker</span>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-fv-black/40 via-transparent to-fv-black pointer-events-none" />
